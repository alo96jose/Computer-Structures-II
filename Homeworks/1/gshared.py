class gshared:
    ...
    def predict(self, PC):
        ...
        # "0000" es un número binario base 2 que al aplicarle int() pasa a ser 0.
        GHR_index = int(self.global_history_reg,2)
        # bitwise XOR operation between the binary representations of the numbers PC_index and GHR_index
        # table_index is also decimal
    ...
    def update(self, PC, result, prediction):
        PC_index = int(PC) % self.size_of_branch_table
        GHR_index = int(self.global_history_reg,2)
        table_index = PC_index ^ GHR_index # ^ is the bitwise XOR operator.
